...
public class Player : MonoBehaviour {
	...
	void Update () {
		...
		if (Input.GetKey(KeyCode.W)) {
			...
			//transform.GetChild(0).LookAt(transform.forward, Vector3.up);
	...
	void Shoot() {
		Instantiate(bullet.transform, bulltetSpawner.transform.position, bulltetSpawner.transform.rotation);
	}
}
